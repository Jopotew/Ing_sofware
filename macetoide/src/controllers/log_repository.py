...
class LogRepository:
    ...
    def get_log_by_id(self, log_id: int) -> Log:
        ...
        pot = Pot(
            ...
            analysis_time=AnalysisTime(log_data["analysis_minutes"], log_data["analysis_hours"]),
            user=User(log_data["user_name"], log_data["user_surname"], log_data["username"], log_data["mail"], "*****")
        )
        ...
        irrigation_event = IrrigationEvent(
            time_active=log_data["irrigation_duration"],
